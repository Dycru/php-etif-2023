<?php
    ...
    $foo = 1 + "10 Small Pigs";       
    // $foo es integer (11) y se emite una E_WARNING en PHP 8.0.0, E_NOTICE previamente
    $foo = 4 + "10.2 Little Piggies"; 
    // $foo es float (14.2) y se emite una E_WARNING en PHP 8.0.0, E_NOTICE previamente
    $foo = "10.0 pigs " + 1;          
    // $foo es float (11) y se emite una E_WARNING en PHP 8.0.0, E_NOTICE previamente
    $foo = "10.0 pigs " + 1.0;        
    // $foo es float (11) y se emite una E_WARNING en PHP 8.0.0, E_NOTICE previamente
